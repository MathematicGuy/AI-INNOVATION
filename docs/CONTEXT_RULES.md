...
| --- | --- |
| Task touches database schema, durable records, or migrations | Read `scripts/schema/` and relevant CLI code before planning. |
| Task touches CLI command behavior or installer distribution | Read `scripts/README.md`, relevant `crates/harness-cli/*` code, CLI help output, and installer docs. |
